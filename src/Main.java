...
class Admin {
    ...
    public static String userx = "Anggara";
    public static String passx = "262626";
...
class Main {
    ...
    public static String[] namaBuku = new String[] {"Angin", "Air", "Udara"};
    public static String[] author = new String[] {"Anggara", "Anggara", "Anggara"};
